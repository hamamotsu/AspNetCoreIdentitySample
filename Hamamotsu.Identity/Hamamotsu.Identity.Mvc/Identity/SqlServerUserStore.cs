...
namespace Hamamotsu.Identity.Mvc.Identity
{
    public class SqlServerUserStore : SqlServerUserStore<IdentityUser<string>>
    {
        /// <summary>
        ...
        public SqlServerUserStore(DbContext context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class SqlServerUserStore<TUser> : SqlServerUserStore<TUser, IdentityRole, DbContext, string>
    ...
    public class SqlServerUserStore<TUser, TRole, TContext> : SqlServerUserStore<TUser, TRole, TContext, string>
        ...
        where TContext : DbContext
    {
        ...
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public SqlServerUserStore(TContext context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class SqlServerUserStore<TUser, TRole, TContext, TKey> : SqlServerUserStore<TUser, TRole, TContext, TKey, IdentityUserClaim<TKey>, IdentityUserRole<TKey>, IdentityUserLogin<TKey>, IdentityUserToken<TKey>, IdentityRoleClaim<TKey>>
    ...
    public class SqlServerUserStore<TUser, TRole, TContext, TKey, TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim> :
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        public SqlServerUserStore(TContext context, IdentityErrorDescriber describer = null) : base(describer ?? new IdentityErrorDescriber())
        {
            if (context == null)
            {
