...
namespace Hamamotsu.Identity.Mvc.Identity
{
    ...
    public class SqlServerRoleStore<TRole> : SqlServerRoleStore<TRole, DbContext, string>
        where TRole : IdentityRole<string>
    {
        ...
        public SqlServerRoleStore(DbContext context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class SqlServerRoleStore<TRole, TContext> : SqlServerRoleStore<TRole, TContext, string>
        where TRole : IdentityRole<string>
        where TContext : DbContext
    {
        ...
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public SqlServerRoleStore(TContext context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class SqlServerRoleStore<TRole, TContext, TKey> : SqlServerRoleStore<TRole, TContext, TKey, IdentityUserRole<TKey>, IdentityRoleClaim<TKey>>,
    ...
    public class SqlServerRoleStore<TRole, TContext, TKey, TUserRole, TRoleClaim> :
        IQueryableRoleStore<TRole>,
        IRoleClaimStore<TRole>
        where TRole : IdentityRole<TKey>
        where TKey : IEquatable<TKey>
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public SqlServerRoleStore(TContext context, IdentityErrorDescriber describer = null)
        {
            if (context == null)
            {
